...
const Hero = () => {
  return (
    <section id="inicio" className="relative bg-gradient-to-br from-primary via-auto-blue-800 to-auto-blue-900 text-white">
      ...
      <div className="relative container mx-auto px-4 py-20 lg:py-32">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl mb-8 text-auto-blue-100 animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Button 
              size="lg" 
              className="bg-accent hover:bg-blue-600 text-white px-8 py-3 text-lg"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
            <div className="text-center">
              ...
              <p className="text-auto-blue-100">Todos os carros com garantia de até 12 meses</p>
            </div>
            <div className="text-center">
              <Star className="h-12 w-12 text-accent mx-auto mb-4" />
              <h3 className="text-xl font-semibold mb-2">Qualidade Certificada</h3>
              <p className="text-auto-blue-100">Veículos revisados e aprovados por nossa equipe</p>
            </div>
            <div className="text-center">
              <Users className="h-12 w-12 text-accent mx-auto mb-4" />
              <h3 className="text-xl font-semibold mb-2">Atendimento Personalizado</h3>
              <p className="text-auto-blue-100">Equipe especializada para te ajudar na melhor escolha</p>
            </div>
          </div>
        </div>
      </div>
